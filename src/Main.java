...
public class Main {
	...
	public void ejecutar() {
		...
		AltaEstudianteMenuDirector AltEstuMenuDirector= new AltaEstudianteMenuDirector();
		...
		AltEstuMenuDirector.setControlador(controlador);
		...
		controlador.setAltEstuMenuDirector(AltEstuMenuDirector);
